IzendaSynergy.Localizer.registerLanguage({
      ...
      COMMON_MESSAGES_FORMAT_TIME: 'Please enter a valid value with only Numeric character.',
      ...
      REPORTDESIGNER_MESSAGE_VALID_FILTERLOGIC_STATEMENT: 'A valid SQL statement can be constructed from the filter logic.',
      ...
      PERMISSION_ICON_TOOLTIP_FULLREPORTDASHBOARDACCESS: 'If this checkbox has been checked, all settings of Reports, Dashboards, Access, Scheduling, Emailing, Exporting will be inherited from its tenant',
